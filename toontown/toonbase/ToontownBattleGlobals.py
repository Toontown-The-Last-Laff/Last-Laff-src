...
AvPropDamage = ((((8, 10), (Levels[0][0], Levels[0][1])),
 ...
 (((8, 10), (Levels[1][0], Levels[1][1])),
  ((12, 20), (Levels[1][1], Levels[1][2])),
  ((30, 40), (Levels[1][2], Levels[1][3])),
  ((50, 70), (Levels[1][3], Levels[1][4])),
  ((75, 90), (Levels[1][4], Levels[1][5])),
 ...
 (((3, 4), (Levels[3][0], Levels[3][1])),
  ...
  ((6, 10), (Levels[3][2], Levels[3][3])),
  ((15, 20), (Levels[3][3], Levels[3][4])),
  ((25, 30), (Levels[3][4], Levels[3][5])),
  ((35, 50), (Levels[3][5], Levels[3][6])),
  ((50, 60), (Levels[3][6], MaxSkill))),
 (((5, 10), (Levels[4][0], Levels[4][1])),
  ((15, 20), (Levels[4][1], Levels[4][2])),
  ((25, 30), (Levels[4][2], Levels[4][3])),
  ((35, 40), (Levels[4][3], Levels[4][4])),
  ((45, 50), (Levels[4][4], Levels[4][5])),
  ((90, 120), (Levels[4][5], Levels[4][6])),
  ((150, 150), (Levels[4][6], MaxSkill))),
 (((3, 5), (Levels[5][0], Levels[5][1])),
  ((6, 8), (Levels[5][1], Levels[5][2])),
  ((8, 10), (Levels[5][2], Levels[5][3])),
  ((15, 20), (Levels[5][3], Levels[5][4])),
  ((25, 30), (Levels[5][4], Levels[5][5])),
  ((45, 50), (Levels[5][5], Levels[5][6])),
  ((105, 105), (Levels[5][6], MaxSkill))),
 (((10, 10), (Levels[6][0], Levels[6][1])),
  ((15, 20), (Levels[6][1], Levels[6][2])),
  ((25, 30), (Levels[6][2], Levels[6][3])),
  ((45, 70), (Levels[6][3], Levels[6][4])),
  ((60, 90), (Levels[6][4], Levels[6][5])),
