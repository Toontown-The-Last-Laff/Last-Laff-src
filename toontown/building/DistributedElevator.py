...
class DistributedElevator(DistributedObject.DistributedObject, Avatar.Avatar):
    ...
    def __init__(self, cr):
        ...
        self.toonRequests = {}
        self.deferredSlots = []
        self.elevatorTagName = 'Suit Elevator'
    ...
    def setupElevator(self):
        ...
        self.nametagEle = NametagGroup()
        self.nametagEle.setFont(ToontownGlobals.getSuitFont())
        self.nametagEle.setColorCode(NametagGroup.CCSuit)
        self.nametagEle.setActive(1)
        self.nametagEle.manage(base.marginManager)
        self.nametagEle.setName(self.elevatorTagName)
        self.nametagEle.setAvatar(self)
