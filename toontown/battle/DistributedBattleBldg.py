    ...
    def setBossBattle(self, value):
        ...
        dept2battleThemes = {'c': ['phase_7/audio/bgm/encntr_general_bg_indoor.ogg',
                             ...
                             'l': ['phase_7/audio/bgm/laff_ara_suitLegalInterior_bottomFloor_1.ogg',
                                   ...
                                   'phase_7/audio/bgm/laff_ara_suitLegalInterior_bottomFloor_4.ogg',
                                   'phase_7/audio/bgm/laff_ara_suitLegalInterior_encntrBoss.ogg'],
                             'm': ['phase_7/audio/bgm/laff_ara_suitMoneyInterior_bottomFloor_1.ogg',
                                   'phase_7/audio/bgm/laff_ara_suitMoneyInterior_bottomFloor_2.ogg',
        ...
        self.battleMusic = base.loader.loadMusic(dept2battleThemes[dept][self.bossBattle])
