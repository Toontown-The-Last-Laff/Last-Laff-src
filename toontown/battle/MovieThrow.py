...
def __doSuitThrows(throws):
    ...
    for throw in throws:
        ...
        tracksnpc = __throwPie(throw, delay, hitCount, npc=1)
        if tracksnpc:
            for tracknpc in tracksnpc:
                toonTracks.append(tracknpc)
...
def __throwPie(throw, delay, hitCount, npc=0):
    npcToon = None
    ...
    try:
        ...
        hand = toon.getPart('torso', 1000).find('**/joint_Rhold')
        pieShow = Func(MovieUtil.showProp, pie, hand)
